...
Or, if you prefer configuring options outside of =use-package=:

#+begin_src emacs-lisp
(setopt johnson-dictionary-directories '("~/dictionaries/"))
(setopt johnson-default-search-scope 'all)
(setopt johnson-dictionary-priorities '(("Oxford English-Spanish" . -10)
                                        ("Collins English-Spanish" . -5)))
