...
Version 0.1 (current) supports the DSL (ABBYY Lingvo) format.  The
following versions will add support for additional dictionary formats
and features.
...
- =_abrv.dsl= abbreviation table support for DSL dictionaries (=[p]=
  tag expansion).
