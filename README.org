...
naming the diagnostics buffer that holds the details:

#+begin_example
[Johnson retrieval worker exited with status STATUS; see BUFFER]
[Johnson retrieval protocol failed: MESSAGE; see BUFFER]
[Johnson retrieval worker failed to start: MESSAGE; see BUFFER]
#+end_example
