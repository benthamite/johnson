...
#+html: <img src="https://github.com/benthamite/johnson/blob/main/johnson.jpg?raw=true" align="right">
...
- [ ] =johnson-stardict.el= backend for =.ifo=, =.idx=, =.dict=, and
  =.syn= files.
- [ ] Dictzip random-access support for compressed =.dict.dz= and
  =.dsl.dz= files.
...
** Version 0.4 --- BGL (Babylon)
:PROPERTIES:
:CUSTOM_ID: h:roadmap-v04
:ID:       D4E5F6A7-B8C9-0123-DEFA-234567890123
:END:

- [ ] =johnson-bgl.el= backend for =.bgl= files.
